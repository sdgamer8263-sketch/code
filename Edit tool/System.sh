...
main_menu() {
    while true; do
        ...
        echo -e "  ${GREEN}5)${NC}  🕵️  Privacy "
        echo -e "  ${GREEN}6)${NC}  🌐 Network (Auto: $NET_MGR)"
        echo -e "  ${GREEN}7)${NC}  📡 Network Testing"
        echo -e "  ${GREEN}8)${NC}  ⚡ Performance (Auto: $ARCH)"
        echo -e "  ${GREEN}9)${NC}  🔄 Resource "
        echo -e "  ${GREEN}10)${NC} 👥 Users "
        echo -e "  ${GREEN}11)${NC} 📊 Monitoring"
        echo -e "  ${GREEN}12)${NC} 📝 Loge "
        echo -e "  ${GREEN}13)${NC} 🧹 Cleanup "
        echo -e "  ${GREEN}14)${NC} 🔧 Maintenance (Auto: $PKG_MGR)"
        echo -e "  ${GREEN}15)${NC} 🚨 Panic"
        echo -e "  ${GREEN}16)${NC} 📁 Files"
        echo -e "  ${GREEN}17)${NC} 🤖 Automation"
        echo -e "  ${GREEN}18)${NC} 📈 History"
        echo -e "  ${GREEN}19)${NC} ⚙️  Presets"
        echo -e "  ${GREEN}20)${NC} 🎨 Menu"
        echo -e "  ${GREEN}21)${NC} ℹ️  Meta"
        echo -e "  ${GREEN}22)${NC} 🔍  Report"
        echo -e "  ${GREEN}23)${NC} 🎯 Smart VPS"
        echo ""
